# Rebrand dari Purwasuka News ke Purwasuka News
...
Write-Log -Message "===== REBRAND PURWASUKA NEWS DIMULAI ====="
...
foreach ($file in $htmlFiles) {
    try {
        ...
        $replacements = @(
            @{ Old = "Purwasuka News"; New = "Purwasuka News" },
            @{ Old = "PurwasukaNews"; New = "PurwasukaNews" },
            @{ Old = "purwasukanews"; New = "purwasukanews" },
            # Social media links
            @{ Old = "https://twitter.com/PurwasukaNews"; New = "https://twitter.com/PurwasukaNews" },
            @{ Old = "https://facebook.com/PurwasukaNews"; New = "https://facebook.com/PurwasukaNews" },
            @{ Old = "https://instagram.com/PurwasukaNews"; New = "https://instagram.com/PurwasukaNews" },
            @{ Old = "https://youtube.com/@PurwasukaNews"; New = "https://youtube.com/@PurwasukaNews" },
            @{ Old = "https://linkedin.com/company/PurwasukaNews"; New = "https://linkedin.com/company/PurwasukaNews" },
            # Email
            @{ Old = "purwasukanews@gmail.com"; New = "purwasukanews@gmail.com" },
            # Logo references
            @{ Old = 'alt="PurwasukaNews"'; New = 'alt="PurwasukaNews"' }
        )
...
foreach ($file in $packageJsonFiles) {
    try {
        ...
        $replacements = @(
            @{ Old = """name"": ""purwasukanews"""; New = """name"": ""purwasukanews""" },
            @{ Old = """name"": ""purwasukanews-article-generator"""; New = """name"": ""purwasukanews-article-generator""" }
        )
...
$searchPatterns = @("Purwasuka News", "purwasukanews", "PurwasukaNews")
$foundIssues = @()
...
Write-Log -Message ""
Write-Log -Message "Rebrand Purwasuka News selesai ✅"
